...
class HuabanCrawler():
    ...
    def __init__(self):
        ...
        self.homeUrl = "http://huaban.com/search/?q=" + str(sys.argv[1])
        print self.homeUrl
        self.images = []
    ...
    def __make_ajax_url(self, No):
        ...
        # return self.homeUrl + "?ifburs0o&max=" + No + "&limit=20&wfl=1"
        return self.homeUrl + "&ifbvdsi8&page=" + No + "&per_page=20&wfl=1"
    ...
    def __process_data(self, htmlPage):
        ...
        for i in result:
            ...
            # if 'image' == i.get("file")("type")[:5]:
            if 'image' == i.get("file", {}).get("type", "NA")[:5]:
            # d.get('a', {}).get('j', 'NA')
